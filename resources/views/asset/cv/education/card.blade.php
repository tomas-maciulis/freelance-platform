<div class="h-10 h-auto min-h-95 mb-2 flex flex-col md:flex-row shadow overflow-visible">
     ...
     <div class="w-full">
         <div class="text-right mr-3">
             ...
             <form method="post" action="{{ route('cv.education.destroy', ['id' => $cv->id, 'educationId' => $education->id]) }}" onsubmit="return confirm('Are you sure you want to delete \'' + {{ $education->specialty }} + '\' education?');">
                 @csrf
